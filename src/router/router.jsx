...
const router = createBrowserRouter([
    {
        ...
        children: [
            {
                index: true,
                loader: () => fetch('https://assignment-11-server-three-silk.vercel.app/foods'),
                Component: Home
            },
            {
                path: '/login',
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://assignment-11-server-three-silk.vercel.app/foods/${params.id}`),
